...
public class BuildListAdapter extends RecyclerView.Adapter<BuildListAdapter.ViewHolder> {
    ...
    public BuildListAdapter(Context context, List<TechnicalWork> listWork,Fragment fragment)
    {
                    ...
                    NetworkService.getInstance(itemView.getContext())
                            ...
                            .enqueue(new Callback<Void>() {
                                ...
                                public void onResponse(Call<Void> call, Response<Void> response) {
                                    ((BuildFragment)fragment).loadTechnicalWork(activeAutoManager.getActiveAutoId());
                                }
