...
public class AllMoneyListAdapter extends RecyclerView.Adapter<AllMoneyListAdapter.ViewHolder> {
    ...
    public AllMoneyListAdapter(Context context, List<Expense> listMoney, AppCompatActivity activity)
    {
                    ...
                    NetworkService.getInstance(itemView.getContext())
                            ...
                            .enqueue(new Callback<Void>() {
                                ...
                                public void onResponse(Call<Void> call, Response<Void> response) {
                                    ((AllMoneyActivity)activity).loadAllExpenses();
                                }
